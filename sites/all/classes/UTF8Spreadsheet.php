...
*/
if (@$GLOBALS["_debug"]) {
	$GLOBALS["_lib"] = __FILE__;
	$GLOBALS["_version"] = '1.05';
	if (isset($GLOBALS["_libs"]) and is_array($GLOBALS["_libs"])) { $GLOBALS["_libs"][__FILE__] = $GLOBALS["_version"]; }
}
